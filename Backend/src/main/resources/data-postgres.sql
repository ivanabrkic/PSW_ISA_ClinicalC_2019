...
insert into korisnik (grad, drzava, adresa, jbo, aktivnost_naloga, email, ime, kontakt_telefon, kor_ime, lozinka, prezime, tip_korisnika) values ('Sabac', 'Srbija', 'Mladena Djuricica 11', 123123123, True , 'tamaralazarevic@gmail.com', 'Tamara', '0652754579', 'tesla', '12345678b', 'Lazarevic', 'Pacijent');
...
insert into korisnik (grad, drzava, adresa, jbo, aktivnost_naloga, email, ime, kontakt_telefon, kor_ime, lozinka, prezime, tip_korisnika) values ('Brazilija', 'Srbija', 'Tarska 40', 342378491, True , 'n.vanilosevic@gmail.com', 'Milance', '0652754579', 'mix', '12345678b', 'Lukic', 'Pacijent');
...
insert into korisnik (grad, drzava, adresa, jbo, aktivnost_naloga, email, ime, kontakt_telefon, kor_ime, lozinka, prezime, tip_korisnika) values ('Brazilija', 'Srbija', 'Tarska 40', 344371291, FALSE, 'n.milosevic0111@gmail.com', 'Vanelee', '0652754579', 'Kix', '12345678b', 'Milosevic', 'Pacijent');
