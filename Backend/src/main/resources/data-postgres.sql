...
insert into korisnik (grad, drzava, adresa, jbo, aktivnost_naloga, email, ime, kontakt_telefon, kor_ime, lozinka, prezime, tip_korisnika) values ('Brazilija', 'Srbija', 'Tarska 40', 342378491, FALSE, 'n.milosevic0111@gmail.com', 'Nikola', '0652754579', 'mix', '12345678b', 'Milo', 'Pacijent');
insert into korisnik (grad, drzava, adresa, jbo, aktivnost_naloga, email, ime, kontakt_telefon, kor_ime, lozinka, prezime, tip_korisnika) values ('Stara Pazova', 'Srbija', 'Vojvode Misica 30', 654132654, True ,'milanlukic@gmail.com', 'Milan', '0652754579', 'vaneleeca', '12345678b', 'Lukic', 'Administrator klinike');
insert into korisnik (grad, drzava, adresa, jbo, aktivnost_naloga, email, ime, kontakt_telefon, kor_ime, lozinka, prezime, tip_korisnika) values ('Backa Palanka', 'Srbija', 'Save Kovacevica 50', 645238967, True, 'ivan@gmail.com', 'Ivan', '0652754579', 'maxiixa', '12345678b', 'Maksimovic', 'Medicinska sestra');
...
insert into korisnik (grad, drzava, adresa, jbo, aktivnost_naloga, email, ime, kontakt_telefon, kor_ime, lozinka, prezime, tip_korisnika) values ('Nova Pazova', 'Srbija', 'Glavna 38', 987987987, True,'n.milosevicNN@gmail.com', 'Nikola', '0652754579', 'Vaneleey', '12345678b', 'Milosev', 'Administrator klinickog centra');
...
insert into lekar (lekar_id, br_slobodnih_dana, klinika_id, radno_vreme, ocena) values (1, 33, 1, 'Pon-10:00-14:00/Uto-7:00:16:00/Sre-12:00-20:00/Cet-19:00-1:00/Pet-13:00-21:00', 2.3);
insert into lekar (lekar_id, br_slobodnih_dana, klinika_id, radno_vreme, ocena) values (2, 54, 1, 'Pon-12:00-14:00/Uto-9:00:17:00/Sre-13:00-21:00/Cet-20:00-1:00/Pet-8:00-12:00', 4.5);
...
insert into medicinska_sestra (meds_id, br_slobodnih_dana, klinika_id, radno_vreme, ocena) values (9, 89, 1, 'Pon-10:00-14:00/Uto-7:00:16:00/Sre-12:00-20:00/Cet-19:00-1:00/Pet-13:00-21:00', 1.3);
insert into medicinska_sestra (meds_id, br_slobodnih_dana, klinika_id, radno_vreme, ocena) values (10, 56, 3, 'Pon-10:00-14:00/Uto-7:00:16:00/Sre-12:00-20:00/Cet-19:00-1:00/Pet-13:00-21:00', 5.0);
